...
public class WordCountSite {
    ...
    private final static IntWritable three = new IntWritable(1);
    private final static IntWritable five = new IntWritable(1);
    private final static IntWritable ten = new IntWritable(1);
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(WordCountSite.class);
